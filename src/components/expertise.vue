<template>
  <section class="p-6 bg-white shadow-sm overflow-hidden overflow-ellipsis rounded-lg max-h-64 h-64">
    <div class="flex pb-6  flex-row">
      ...
      >
        <i class="my-auto scale-150 transform">
          <svg width="24" height="24" viewBox="0 0 24 24" :color="expertise.fill" :fill="expertise.fill">
            <path
                :d="expertise.logo"
            />
          </svg>
