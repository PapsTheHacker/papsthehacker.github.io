<template>
  <div class="flex justify-between">
    <div class="flex">
      <img src="/promise-as-logo.jpg" alt="Logo" class="rounded-full" width="45" height="45">
    </div>
    <div class="flex pt-3 ">
    ...
    <ul class="flex pt-2">
      <li class="pr-8">
        <a :href="social.facebook" target="_blank" class="" title="Facebook">
          <i>
            <svg width="24" height="24" viewBox="0 0 24 24"  class="text-red-500">
              <path
      ...
      <li class="pr-8">
        <a :href="social.twitter" target="_blank" class="" title="Twitter">
          <i>
      ...
      <li class="pr-8">
        <a :href="social.codepen" target="_blank" class="" title="Codepen">
          <i>
            <svg width="24" height="24" viewBox="0 0 24 24">
              <path
      ...
      <li class="">
        <a :href="social.github" target="_blank" class="" title="GitHub">
          <i>
            <svg width="24" height="24" viewBox="0 0 24 24">
              <path
  ...
  data() {
    return {
      social: {
        ...
        twitter: 'https://twitter.com/promise-sudo',
